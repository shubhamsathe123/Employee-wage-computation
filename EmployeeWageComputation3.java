...
public class EmployeeWageComputation3 implements IComputeEmpWageForComp{
	...
	public static void main(String args[]) {
		EmployeeWageComputation3 employeeWageBuilder = new EmployeeWageComputation3();
